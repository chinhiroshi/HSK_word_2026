...
const HSK_QUOTES: Record<HskLevel, QuoteData> = {
  1: {
    ...
    modernEn: "Never stop learning, and never tire of guiding others. This is the spirit of a true lifelong learner.",
  },
  2: {
    ...
    modernEn: "By reflecting on what you already know and finding fresh insights in it, you reach a level where you can guide others.",
  },
  3: {
    ...
    literalEn: "When three walk together, one is surely my teacher. Follow the good in them; correct in yourself what they do poorly.",
    modernEn: "No matter who you are with, there is always someone to learn from. Adopt their strengths, and let their faults be a mirror for self-reflection.",
  },
  4: {
    ...
    literalEn: "Mountains end, waters end — one fears there is no way forward. Yet through shadowed willows and bright blossoms, a village appears.",
    modernEn: "Just when you feel there is no path ahead, an unexpected new world opens before you. Never give up — a breakthrough is always possible.",
  },
  5: {
    ...
    literalEn: "The moment will come when great winds shatter the waves; then raise the cloud-sail and cross the vast blue sea.",
    modernEn: "Even against headwinds, the time to surge forward will surely arrive. When it does, set your sail and press boldly across the open ocean.",
  },
  6: {
    ...
    literalEn: "I will reach the very summit, and from there all other mountains will look small.",
    modernEn: "Once you stand at the top, every obstacle that once seemed great will appear small. Keep aiming for the heights.",
  },
};
