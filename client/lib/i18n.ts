...
const translations = {
  ja: {
    ...
    reset_btn: "リセット",
    reset_text_needs_work: "文字暗記必要をまだに戻す",
    reset_audio_needs_work: "音声暗記必要をまだに戻す",
    reset_needs_work_confirm: "「暗記必要」の単語をすべて「まだ」に戻します。よろしいですか？",
  ...
  en: {
    ...
    reset_text_needs_work: "Reset text needs-work to not started",
    reset_audio_needs_work: "Reset audio needs-work to not started",
    reset_needs_work_confirm: "All \"needs work\" words will be moved back to \"not started\". Are you sure?",
    reset_btn: "Reset",
